...
export interface TranslationKey {
  ...
  diagTreatmentLoading: string;
  diagTreatmentBiological: string;
  diagTreatmentChemical: string;
  diagTreatmentOrganic: string;
  diagTreatmentManual: string;
  // Calculator
  calcPlanNext: string;
  calcTitle: string;
  calcSubtitle: string;
 ...
 scanErrInvalidImage: string;
  ...
  paRetry: string;
  // Scheme category labels
  catIncomeSupport: string;
  catInsurance: string;
  catCredit: string;
  catSubsidy: string;
  catSoilHealth: string;
  catOrganicFarming: string;
  catIrrigation: string;
  catPriceSupport: string;
  catWomenFarmers: string;
  catLivestockDairy: string;
  catHorticulture: string;
  catMarketAccess: string;
  // Farmer category labels
  fcAll: string;
  fcSmallMarginal: string;
  fcLarge: string;
  fcTenant: string;
  fcWomen: string;
  fcOrganic: string;
...
export const translations: Record<Language, TranslationKey> = {
  en: {
    ...
    catIncomeSupport: 'Income Support', catInsurance: 'Insurance', catCredit: 'Credit & Loans', catSubsidy: 'Subsidy', catSoilHealth: 'Soil Health', catOrganicFarming: 'Organic Farming', catIrrigation: 'Irrigation', catPriceSupport: 'Price Support', catWomenFarmers: 'Women Farmers', catLivestockDairy: 'Livestock & Dairy', catHorticulture: 'Horticulture', catMarketAccess: 'Market Access', 
    fcAll: 'All Farmers', fcSmallMarginal: 'Small & Marginal', fcLarge: 'Large Farmers', fcTenant: 'Tenant / Sharecropper', fcWomen: 'Women Farmers', fcOrganic: 'Organic Farmers', 
  },
  hi: {
    ...
    diagAboutIssue: 'इस समस्या के बारे में', diagPrevention: 'रोकथाम', diagPreventionDesc: 'भविष्य में इसे रोकने के कदम', diagTreatment: 'उपचार', diagTreatmentDesc: 'अभी क्या करें', diagTreatmentFallback: 'सक्रिय उपचार विकल्पों के लिए अपने निकटतम कृषि अधिकारी या किसान हेल्पलाइन से संपर्क करें।', diagTreatmentLoading: 'विशिष्ट उपचार विकल्प प्राप्त कर रहे हैं...', diagTreatmentBiological: 'जैविक नियंत्रण', diagTreatmentChemical: 'रासायनिक उपचार', diagTreatmentOrganic: 'जैव-विकल्प', diagTreatmentManual: 'शारीरिक नियंत्रण',
    ...
    catIncomeSupport: 'आय सहायता', catInsurance: 'बीमा', catCredit: 'क्रेडिट और ऋण', catSubsidy: 'सब्सिडी', catSoilHealth: 'मिट्टी स्वास्थ्य', catOrganicFarming: 'जैविक खेती', catIrrigation: 'सिंचाई', catPriceSupport: 'मूल्य सहायता', catWomenFarmers: 'महिला किसान', catLivestockDairy: 'पशुधन और डेयरी', catHorticulture: 'बागवानी', catMarketAccess: 'बाजार पहुँच', 
    fcAll: 'सभी किसान', fcSmallMarginal: 'छोटे और सीमांत', fcLarge: 'बड़े किसान', fcTenant: 'बटाईदार / पट्टेदार', fcWomen: 'महिला किसान', fcOrganic: 'जैविक किसान', 
  },
  bn: {
    ...
    diagAboutIssue: 'এই সমস্যা সম্পর্কে', diagPrevention: 'প্রতিরোধ', diagPreventionDesc: 'ভবিষ্যতে এটি রোধ করার পদক্ষেপ', diagTreatment: 'চিকিৎসা', diagTreatmentDesc: 'এখন কী করবেন', diagTreatmentFallback: 'সক্রিয় চিকিৎসার বিকল্পের জন্য আপনার নিকটতম কৃষি অফিসার বা কিসান হেল্পলাইনে যোগাযোগ করুন।', diagTreatmentLoading: 'নির্দিষ্ট চিকিৎসা বিকল্প আনা হচ্ছে...', diagTreatmentBiological: 'জৈবিক নিয়ন্ত্রণ', diagTreatmentChemical: 'রাসায়নিক চিকিৎসা', diagTreatmentOrganic: 'জৈব বিকল্প', diagTreatmentManual: 'শারীরিক নিয়ন্ত্রণ',
    ...
    catIncomeSupport: 'আয় সহায়তা', catInsurance: 'বীমা', catCredit: 'ক্রেডিট ও ঋণ', catSubsidy: 'ভর্তুকি', catSoilHealth: 'মাটির স্বাস্থ্য', catOrganicFarming: 'জৈব চাষ', catIrrigation: 'সেচ', catPriceSupport: 'মূল্য সহায়তা', catWomenFarmers: 'নারী কৃষক', catLivestockDairy: 'পশুপালন ও ডেইরি', catHorticulture: 'বাগান', catMarketAccess: 'বাজার অ্যাক্সেস', 
    fcAll: 'সব কৃষক', fcSmallMarginal: 'ছোট ও প্রান্তিক', fcLarge: 'বড় কৃষক', fcTenant: 'বর্গাদার / প্ট্টাদার', fcWomen: 'নারী কৃষক', fcOrganic: 'জৈব কৃষক', 
  },
  te: {
    ...
    diagAboutIssue: 'ఈ సమస్య గురించి', diagPrevention: 'నివారణ', diagPreventionDesc: 'భవిష్యత్తులో దీన్ని నివారించడానికి చర్యలు', diagTreatment: 'చికిత్స', diagTreatmentDesc: 'ఇప్పుడు ఏమి చేయాలి', diagTreatmentFallback: 'సక్రియ చికిత్స ఎంపికల కోసం మీ సమీప వ్యవసాయ అధికారి లేదా కిసాన్ హెల్ప్‌లైన్‌ను సంప్రదించండి.', diagTreatmentLoading: 'నిర్దిష్ట చికిత్స ఎంపికలను పొందుతోంది...', diagTreatmentBiological: 'జీవ నియంత్రణ', diagTreatmentChemical: 'రసాయనిక చికిత్స', diagTreatmentOrganic: 'సేంద్రీయ ఎంపిక', diagTreatmentManual: 'భౌతిక నియంత్రణ',
    ...
    catIncomeSupport: 'ఆదాయ సహాయం', catInsurance: 'బీమా', catCredit: 'క్రెడిట్ & రుణాలు', catSubsidy: 'రాయితీ', catSoilHealth: 'నేల ఆరోగ్యం', catOrganicFarming: 'సేంద్రీయ వ్యవసాయం', catIrrigation: 'నీటిపారుదల', catPriceSupport: 'ధర మద్దతు', catWomenFarmers: 'మహిళా రైతులు', catLivestockDairy: 'పశువులు & డెయిరీ', catHorticulture: 'ఉద్యానవనం', catMarketAccess: 'మార్కెట్ యాక్సెస్', 
    fcAll: 'అన్ని రైతులు', fcSmallMarginal: 'చిన్న & సాహసిక', fcLarge: 'పెద్ద రైతులు', fcTenant: 'కౌలుదారు / పట్టాదారు', fcWomen: 'మహిళా రైతులు', fcOrganic: 'సేంద్రీయ రైతులు', 
  },
  mr: {
    ...
    diagAboutIssue: 'या समस्येबद्दल', diagPrevention: 'प्रतिबंध', diagPreventionDesc: 'भविष्यात हे टाळण्यासाठी उपाय', diagTreatment: 'उपचार', diagTreatmentDesc: 'आता काय करावे', diagTreatmentFallback: 'सक्रिय उपचार पर्यायांसाठी तुमच्या जवळच्या कृषी अधिकाऱ्याशी किंवा किसान हेल्पलाईनशी संपर्क करा.', diagTreatmentLoading: 'विशिष्ट उपचार पर्याय मिळवत आहे...', diagTreatmentBiological: 'जैविक नियंत्रण', diagTreatmentChemical: 'रासायनिक उपचार', diagTreatmentOrganic: 'सेंद्रिय पर्याय', diagTreatmentManual: 'शारीरिक नियंत्रण',
    ...
    catIncomeSupport: 'आय सहाय्य', catInsurance: 'विमा', catCredit: 'कर्ज व क्रेडिट', catSubsidy: 'अनुदान', catSoilHealth: 'माती आरोग्य', catOrganicFarming: 'सेंद्रिय शेती', catIrrigation: 'ओलित', catPriceSupport: 'किंमत सहाय्य', catWomenFarmers: 'महिला शेतकरी', catLivestockDairy: 'पशुसंवर्धन व डेअरी', catHorticulture: 'बागायती', catMarketAccess: 'बाजार प्रवेश', 
    fcAll: 'सर्व शेतकरी', fcSmallMarginal: 'लहान व सीमांत', fcLarge: 'मोठे शेतकरी', fcTenant: 'कौलू / भाडेकरू', fcWomen: 'महिला शेतकरी', fcOrganic: 'सेंद्रिय शेतकरी', 
  },
  ta: {
    ...
    diagAboutIssue: 'இந்த பிரச்சனை பற்றி', diagPrevention: 'தடுப்பு', diagPreventionDesc: 'எதிர்காலத்தில் இதைத் தடுக்க நடவடிக்கைகள்', diagTreatment: 'சிகிச்சை', diagTreatmentDesc: 'இப்போது என்ன செய்ய வேண்டும்', diagTreatmentFallback: 'செயலில் சிகிச்சை விருப்பங்களுக்கு, உங்கள் அருகிலுள்ள வேளாண் அதிகாரியை அல்லது கிசான் ஹெல்ப்லைனை தொடர்பு கொள்ளவும்.', diagTreatmentLoading: 'குறிப்பிட்ட சிகிச்சை விருப்பங்களைப் பெறுகிறது...', diagTreatmentBiological: 'உயிரியல் கட்டுப்பாடு', diagTreatmentChemical: 'வேதியியல் சிகிச்சை', diagTreatmentOrganic: 'இயற்கை விருப்பம்', diagTreatmentManual: 'உடல் கட்டுப்பாடு',
    ...
    catIncomeSupport: 'வருமான உதவி', catInsurance: 'காப்பீடு', catCredit: 'கடன் & நிதி', catSubsidy: 'மானியம்', catSoilHealth: 'மண் ஆரோக்கியம்', catOrganicFarming: 'இயற்கை வேளாண்மை', catIrrigation: 'நீர்ப்பாசனம்', catPriceSupport: 'விலை ஆதரவு', catWomenFarmers: 'பெண் விவசாயிகள்', catLivestockDairy: 'கால்நடை & பால்', catHorticulture: 'தோட்டக்கலை', catMarketAccess: 'சந்தை அணுகல்', 
    fcAll: 'அனைத்து விவசாயிகள்', fcSmallMarginal: 'சிறு & விளாம்பல்', fcLarge: 'பெரிய விவசாயிகள்', fcTenant: 'குத்தகை / பகிர்வு', fcWomen: 'பெண் விவசாயிகள்', fcOrganic: 'இயற்கை விவசாயிகள்', 
  },
};
