...
export interface TranslationKey {
  ...
  scanErrGeminiFetch: string;
  scanErrGeminiApi: string;
  scanErrParse: string;
...
export const translations: Record<Language, TranslationKey> = {
  en: {
    ...
    scanCropType: 'Crop type', scanGrowthStage: 'Growth stage', scanAnalysing: 'Analysing your photo...', scanAnalyseThis: 'Analyse this crop', scanUseSample: 'Use sample photo & analyse',
    ...
    diagOfflineMode: 'Offline knowledge mode', diagOfflineDesc: 'AI photo analysis is unavailable, so this result is based on general crop knowledge. For an exact diagnosis, add a Gemini API key or call the Kisan helpline.',
    ...
    scanErrApiKeyMissing: 'AI diagnosis is not available — the Gemini API key is missing. Please contact the app administrator, or call the Kisan helpline at 1800-180-1551.',
    scanErrGeminiFetch: 'Could not reach the Gemini API. Please check your internet connection and try again.',
    scanErrGeminiApi: 'The Gemini API returned an error. Please try again in a moment.',
  ...
  hi: {
    ...
    scanCropType: 'फसल का प्रकार', scanGrowthStage: 'वृद्धि चरण', scanAnalysing: 'आपकी फोटो का विश्लेषण हो रहा है...', scanAnalyseThis: 'इस फसल का विश्लेषण करें', scanUseSample: 'नमूना फोटो उपयोग करें और विश्लेषण करें',
    ...
    scanErrApiKeyMissing: 'AI निदान उपलब्ध नहीं है — Gemini API कुंजी गायब है। कृपया ऐप व्यवस्थापक से संपर्क करें, या किसान हेल्पलाइन 1800-180-1551 पर कॉल करें।',
    scanErrGeminiFetch: 'Gemini API तक नहीं पहुंच सका। कृपया अपना इंटरनेट जांचें और पुनः प्रयास करें।',
    scanErrGeminiApi: 'Gemini API ने त्रुटि दी। कृपया थोड़ी देर बाद पुनः प्रयास करें।',
  ...
  bn: {
    ...
    scanCropType: 'ফসলের ধরন', scanGrowthStage: 'বৃদ্ধির পর্যায়', scanAnalysing: 'আপনার ছবি বিশ্লেষণ হচ্ছে...', scanAnalyseThis: 'এই ফসল বিশ্লেষণ করুন', scanUseSample: 'নমুনা ছবি ব্যবহার করুন ও বিশ্লেষণ করুন',
    ...
    scanErrApiKeyMissing: 'AI নির্ণয় উপলব্ধ নয় — Gemini API কী অনুপস্থিত। কৃপয়া অ্যাপ প্রশাসকের সাথে যোগাযোগ করুন, বা কিসান হেল্পলাইন 1800-180-1551 এ কল করুন।',
    scanErrGeminiFetch: 'Gemini API-তে পৌঁছানো গেল না। কৃপয়া আপনার ইন্টারনেট পরীক্ষা করুন এবং আবার চেষ্টা করুন।',
    scanErrGeminiApi: 'Gemini API ত্রুটি দিয়েছে। কৃপয়া একটু পরে আবার চেষ্টা করুন।',
  ...
  te: {
    ...
    scanCropType: 'పంట రకం', scanGrowthStage: 'ఎదుగు దశ', scanAnalysing: 'మీ ఫోటోను విశ్లేషిస్తోంది...', scanAnalyseThis: 'ఈ పంటను విశ్లేషించండి', scanUseSample: 'నమూనా ఫోటో ఉపయోగించి విశ్లేషించండి',
    ...
    scanErrApiKeyMissing: 'AI నిర్ధారణ అందుబాటులో లేదు — Gemini API కీ లేదు. దయచేసి యాప్ నిర్వాహకుడిని సంప్రదించండి, లేదా కిసాన్ హెల్ప్‌లైన్ 1800-180-1551 కు కాల్ చేయండి.',
    scanErrGeminiFetch: 'Gemini API కి చేరుకోలేకపోయాను. దయచేసి మీ ఇంటర్నెట్ తనిఖీ చేసి మళ్లీ ప్రయత్నించండి.',
    scanErrGeminiApi: 'Gemini API లో లోపం వచ్చింది. దయచేసి కొద్దిగా ఆగి మళ్లీ ప్రయత్నించండి.',
  ...
  mr: {
    ...
    scanCropType: 'पीक प्रकार', scanGrowthStage: 'वाढीचा टप्पा', scanAnalysing: 'तुमची फोटो विश्लेषण होत आहे...', scanAnalyseThis: 'या पिकाचे विश्लेषण करा', scanUseSample: 'नमुना फोटो वापरा आणि विश्लेषण करा',
    ...
    scanErrApiKeyMissing: 'AI निदान उपलब्ध नाही — Gemini API की गहाळ आहे. कृपया अॅप व्यवस्थापकांशी संपर्क करा, किंवा किसान हेल्पलाइन 1800-180-1551 वर कॉल करा.',
    scanErrGeminiFetch: 'Gemini API पर्यंत पोहोचले नाही. कृपया तुमचे इंटरनेट तपासा आणि पुन्हा प्रयत्न करा.',
    scanErrGeminiApi: 'Gemini API ने त्रुटी दिली. कृपया थोड्या वेळाने पुन्हा प्रयत्न करा.',
  ...
  ta: {
    ...
    scanCropType: 'பயிர் வகை', scanGrowthStage: 'வளர்ச்சி நிலை', scanAnalysing: 'உங்கள் புகைப்படம் ஆய்வாகிறது...', scanAnalyseThis: 'இந்த பயிரை ஆய்வு செய்யவும்', scanUseSample: 'மாதிரி புகைப்படம் பயன்படுத்தி ஆய்வு செய்யவும்',
    ...
    scanErrApiKeyMissing: 'AI கண்டறிதல் கிடைக்கவில்லை — Gemini API விசை இல்லை. ஆப் நிர்வாகியை தொடர்பு கொள்ளவும், அல்லது கிசான் ஹெல்ப்லைன் 1800-180-1551 க்கு அழைக்கவும்.',
    scanErrGeminiFetch: 'Gemini API க்கு செல்ல முடியவில்லை. உங்கள் இணையத்தை சரிபார்த்து மீண்டும் முயற்சிக்கவும்.',
    scanErrGeminiApi: 'Gemini API பிழையை வழங்கியது. சற்று நேரம் கழித்து மீண்டும் முயற்சிக்கவும்.',
